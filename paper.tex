...
- erst Licensen mit \texttt{sh license} sehen dass securityk9 nicht aktivated ist
- diese als Evaluation (evalRightToUse)  über \texttt{license boot level securityk9} für 60 Tage aktivieren und dann \texttt{write} und \texttt{reload}
...
-dieser 69mbits durchsatz kann erhöht werden, wenn eine QOS Policy wie in \Cref{PolicyQOS} genutzt wird, die die Geschwindigkeit auf 84000000 bps begrenzt \url{https://integratingit.wordpress.com/2014/05/14/cisco-isr-g2-router-bad-ipsec-performance/}
\begin{lstlisting}[
caption={Policy QOS},
label=PolicyQOS,
language=bash]
