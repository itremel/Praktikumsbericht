...
- dann $export DISPLAY=:0$, wodurch xeyes als fenster in windows ausgegeben wird, zusätzlich noch windows defender ausschalten
...
-firefox ging in 20.04 wenn man firefox 69 nimmt \url{https://github.com/microsoft/WSL/issues/4964} und dieses über ubuntuzilla mit 69.0.3 herunterlädt \url{https://askubuntu.com/questions/661186/how-to-install-previous-firefox-version}, dann $sudo chmod -R ugo-w$ \path{/usr/bin/firefox} auf readonly 
\begin{lstlisting}[language=bash]
fehlende latex packages
